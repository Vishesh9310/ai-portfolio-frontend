...
const Footer = () => {
    return (
        <footer className="bg-gray-900 text-gray-300 px-4">
            <h1 className="text-center py-8 text-xl sm:text-2xl text-purple-400">
                Let's Collaborate – Feel free to reach out!
            </h1>

            <hr className="border-cyan-700 mx-4 sm:mx-20" />

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 py-8 text-center sm:text-left">
